...
<script type="module">
import { VDOM } from 'https://cdn.jsdelivr.net/npm/@mintjamsinc/ichigojs@0.1.71/dist/ichigo.esm.min.js';
...
| `sdk.start()` | Listen for host messages, start the standalone watchdog, post `ready`. Idempotent. |
