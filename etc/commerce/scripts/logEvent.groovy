// Persist an inbound integration event to the durable event log.
//
...
// raw payload so the event can be replayed and audited, and is the normalized
// record that makes every topic a first-class business event.
//
