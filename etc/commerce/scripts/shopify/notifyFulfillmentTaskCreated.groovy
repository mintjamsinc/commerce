...
//
// Delivery goes through commerce.Notifications under the "fulfillment" category:
...
Notifications.dispatch(log, "notifyFulfillmentTaskCreated", config, message, Notifications.CAT_FULFILLMENT)
